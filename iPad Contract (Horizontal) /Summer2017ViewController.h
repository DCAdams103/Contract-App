...
//
//@interface Summer2017Viewcontroller : UIViewController <UIScrollViewDelegate> {
//    
//    SKView *skView;
//    
//    CGPoint scrollPoint;
...
//
////@property (nonatomic, assign) BOOL _017SpringChosen1;
//@property (nonatomic, assign) BOOL _017SummerChosen1;
//@property (nonatomic, assign) BOOL _017FallChosen1;
...
//@property (nonatomic, weak) __weak IBOutlet UILabel *semesterYearLabel;
...
//@property (nonatomic, weak) __weak IBOutlet UITextField *confirmEmailField;
...
//@property (nonatomic, assign) BOOL payingDeposit;
//@property (nonatomic, assign) BOOL studentNameFilled;
//@property (nonatomic, assign) BOOL emailFilled;
//@property (nonatomic, assign) BOOL confirmEmailFilled;
//@property (nonatomic, assign) BOOL confirmEmailMatch;
...
//@property (nonatomic, assign) BOOL turnDepositOn;
//
