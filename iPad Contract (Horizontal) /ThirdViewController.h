...
@property (nonatomic, weak) NSString *paymentString1;
@property (nonatomic, weak) NSString *paymentString2;
@property (nonatomic, weak) NSString *paymentString3;
@property (nonatomic, weak) NSString *studentNameString1;
@property (nonatomic, weak) NSString *parentNameString1;
@property (nonatomic, weak) NSString *emailString1;
@property (nonatomic, weak) NSString *dayString1;
@property (nonatomic, weak) NSString *timeString1;
@property (nonatomic, weak) NSString *numLessonsString1;
@property (nonatomic, weak) NSString *dateString1;
@property (nonatomic, weak) NSString *phoneNumber2;
@property (nonatomic, weak) NSString *instructorName2;
